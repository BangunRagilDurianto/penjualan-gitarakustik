...
<body>
  ...
  <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-danger fixed-top">
    <div class="container">
      <a class="navbar-brand" href="index.php" style="font-size: 30px;">Gitar<b>Akustik</b></a>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          <li class="nav-item">
            <a class="nav-link" href="index.php" style="color: #ffffff;"><span class="fa fa-home"></span> Home</a>
          </li>
          <li class="nav-item">
  ...
  ?>
    ...
    <footer class="py-3 bg-dark" style="margin-top: 100px;">
      <div class="container">
        <p class="m-0 text-center text-white">&copy; 2022 | &nbsp; All Rights Reserved | &nbsp; Email us: bangunragil30@gmail.com</p>
      </div>
      <!-- /.container -->
    </footer>
