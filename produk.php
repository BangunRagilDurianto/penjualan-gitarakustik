<div class="container">
  <br>
  <center>
    <h1 class="my-4 ">Silahkan pilih gitar akustik dibawah ini</h1><br>
  </center>
      ...
      <div class="mb-4" style="margin-left: 65px;">
        <div class="card h-100">
          <h4 class="card-header">
            <center><?php echo $hasil['nama_produk']; ?></center>
          </h4>
          <div class="card-body">
          ...
          <div class="card-body">
            ...
            ?>
            <a href="page/customer/proses_beli.php?id_produk=<?= $hasil['id_produk'] ?>" class="<?php echo $disable; ?>"><span class="fa fa-shopping-cart" title="shopping cart"></span> Beli</a>
